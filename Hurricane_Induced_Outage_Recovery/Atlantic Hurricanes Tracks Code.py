...
# ----------------------------------------------------
hurricane_shapefile_dir = # Define file paths, containing hurricanes tracks data
county_shapefile_path = # Define file path, counties geographic data
state_shapefile_path = # Define file path, states geographic data
